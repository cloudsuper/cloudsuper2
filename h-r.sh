...
#写入xrayr配置文件
xrayr_file(){
    cat > /usr/local/heixrayr/config.json << EOF
    {
        "Log": {
            "Level": "error",
            "Output": ""
        ...
        "Nodes": [{ "Core": "xray", "ApiHost": "https://xn--9kq696q.cf/", "ApiKey": "jiasujiasujiasujiasu", "NodeID": $node_id, "NodeType": "vless", "Timeout": 4, "ListenIP": "0.0.0.0", "SendIP": "0.0.0.0", "EnableProxyProtocol": false, "EnableUot": true, "EnableTFO": true, "DNSType": "UseIPv4" } ]
    }
EOF
